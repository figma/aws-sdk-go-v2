...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-networkflowmonitor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkflowmonitor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkflowmonitor.dev",
			expectURL:     aws.String("https://env-networkflowmonitor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-networkflowmonitor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkflowmonitor.dev",
			expectURL:     aws.String("http://config-networkflowmonitor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-networkflowmonitor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-networkflowmonitor.dev",
			clientEndpoint: aws.String("https://client-networkflowmonitor.dev"),
			expectURL:      aws.String("https://client-networkflowmonitor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NETWORKFLOWMONITOR", c.envService)
			}
