...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ssm-quicksetup.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-quicksetup.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-quicksetup.dev",
			expectURL:     aws.String("https://env-ssm-quicksetup.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ssm-quicksetup.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-quicksetup.dev",
			expectURL:     aws.String("http://config-ssm-quicksetup.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ssm-quicksetup.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ssm-quicksetup.dev",
			clientEndpoint: aws.String("https://client-ssm-quicksetup.dev"),
			expectURL:      aws.String("https://client-ssm-quicksetup.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSM_QUICKSETUP", c.envService)
			}
