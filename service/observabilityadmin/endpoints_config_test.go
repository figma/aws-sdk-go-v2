...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-observabilityadmin.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-observabilityadmin.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-observabilityadmin.dev",
			expectURL:     aws.String("https://env-observabilityadmin.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-observabilityadmin.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-observabilityadmin.dev",
			expectURL:     aws.String("http://config-observabilityadmin.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-observabilityadmin.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-observabilityadmin.dev",
			clientEndpoint: aws.String("https://client-observabilityadmin.dev"),
			expectURL:      aws.String("https://client-observabilityadmin.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OBSERVABILITYADMIN", c.envService)
			}
