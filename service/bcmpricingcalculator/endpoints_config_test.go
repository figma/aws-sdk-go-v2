...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bcm-pricing-calculator.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-pricing-calculator.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-pricing-calculator.dev",
			expectURL:     aws.String("https://env-bcm-pricing-calculator.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bcm-pricing-calculator.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-pricing-calculator.dev",
			expectURL:     aws.String("http://config-bcm-pricing-calculator.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bcm-pricing-calculator.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bcm-pricing-calculator.dev",
			clientEndpoint: aws.String("https://client-bcm-pricing-calculator.dev"),
			expectURL:      aws.String("https://client-bcm-pricing-calculator.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BCM_PRICING_CALCULATOR", c.envService)
			}
