...
require (
	github.com/figma/aws-sdk-go-v2 v1.37.0-newtest.1
	github.com/figma/aws-sdk-go-v2/aws/protocol/eventstream v1.7.0-newtest.1
	github.com/figma/aws-sdk-go-v2/internal/configsources v1.4.0-newtest.1
	github.com/figma/aws-sdk-go-v2/internal/endpoints/v2 v2.7.0-newtest.1
