...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-controlcatalog.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-controlcatalog.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-controlcatalog.dev",
			expectURL:     aws.String("https://env-controlcatalog.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-controlcatalog.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-controlcatalog.dev",
			expectURL:     aws.String("http://config-controlcatalog.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-controlcatalog.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-controlcatalog.dev",
			clientEndpoint: aws.String("https://client-controlcatalog.dev"),
			expectURL:      aws.String("https://client-controlcatalog.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONTROLCATALOG", c.envService)
			}
