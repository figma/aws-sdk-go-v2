...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ssm-guiconnect.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-guiconnect.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-guiconnect.dev",
			expectURL:     aws.String("https://env-ssm-guiconnect.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ssm-guiconnect.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-guiconnect.dev",
			expectURL:     aws.String("http://config-ssm-guiconnect.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ssm-guiconnect.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ssm-guiconnect.dev",
			clientEndpoint: aws.String("https://client-ssm-guiconnect.dev"),
			expectURL:      aws.String("https://client-ssm-guiconnect.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSM_GUICONNECT", c.envService)
			}
