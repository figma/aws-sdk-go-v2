...
import (
	...
	"context"
	"fmt"
	"github.com/figma/aws-sdk-go-v2/service/keyspacesstreams/types"
...
func (m *awsAwsjson10_serializeOpGetRecords) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	httpBindingEncoder.SetHeader("X-Amz-Target").String("KeyspacesStreams.GetRecords")
...
func (m *awsAwsjson10_serializeOpGetShardIterator) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	httpBindingEncoder.SetHeader("Content-Type").String("application/x-amz-json-1.0")
	httpBindingEncoder.SetHeader("X-Amz-Target").String("KeyspacesStreams.GetShardIterator")
...
type awsAwsjson10_serializeOpGetStream struct {
}

func (*awsAwsjson10_serializeOpGetStream) ID() string {
	return "OperationSerializer"
}

func (m *awsAwsjson10_serializeOpGetStream) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	httpBindingEncoder.SetHeader("Content-Type").String("application/x-amz-json-1.0")
	httpBindingEncoder.SetHeader("X-Amz-Target").String("KeyspacesStreams.GetStream")

	jsonEncoder := smithyjson.NewEncoder()
	if err := awsAwsjson10_serializeOpDocumentGetStreamInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func (m *awsAwsjson10_serializeOpListStreams) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	httpBindingEncoder.SetHeader("Content-Type").String("application/x-amz-json-1.0")
	httpBindingEncoder.SetHeader("X-Amz-Target").String("KeyspacesStreams.ListStreams")
...
func awsAwsjson10_serializeOpDocumentGetStreamInput(v *GetStreamInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
