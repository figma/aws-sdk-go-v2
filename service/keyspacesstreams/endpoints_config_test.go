...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-keyspacesstreams.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-keyspacesstreams.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-keyspacesstreams.dev",
			expectURL:     aws.String("https://env-keyspacesstreams.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-keyspacesstreams.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-keyspacesstreams.dev",
			expectURL:     aws.String("http://config-keyspacesstreams.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-keyspacesstreams.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-keyspacesstreams.dev",
			clientEndpoint: aws.String("https://client-keyspacesstreams.dev"),
			expectURL:      aws.String("https://client-keyspacesstreams.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KEYSPACESSTREAMS", c.envService)
			}
