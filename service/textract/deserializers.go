...
import (
	...
	"github.com/figma/aws-sdk-go-v2/service/textract/types"
		...
		case "RotationAngle":
			if value != nil {
				...
				case json.Number:
					...
					sv.RotationAngle = ptr.Float32(float32(f64))
				...
				default:
					return fmt.Errorf("expected Angle to be a JSON Number, got %T instead", value)
