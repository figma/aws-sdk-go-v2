...
func TestEndpointCase0(t *testing.T) {
	...
	uri, _ := url.Parse("https://eks-auth-fips.us-east-1.api.aws")
...
func TestEndpointCase1(t *testing.T) {
	...
	uri, _ := url.Parse("https://eks-auth.us-east-1.api.aws")
...
func TestEndpointCase2(t *testing.T) {
	...
	uri, _ := url.Parse("https://eks-auth-fips.cn-north-1.api.amazonwebservices.com.cn")
...
func TestEndpointCase3(t *testing.T) {
	...
	uri, _ := url.Parse("https://eks-auth.cn-north-1.api.amazonwebservices.com.cn")
...
func TestEndpointCase4(t *testing.T) {
	...
	uri, _ := url.Parse("https://eks-auth-fips.us-gov-east-1.api.aws")
...
func TestEndpointCase5(t *testing.T) {
	...
	uri, _ := url.Parse("https://eks-auth.us-gov-east-1.api.aws")
