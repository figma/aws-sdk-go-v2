...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-dsql.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dsql.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dsql.dev",
			expectURL:     aws.String("https://env-dsql.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-dsql.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dsql.dev",
			expectURL:     aws.String("http://config-dsql.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-dsql.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-dsql.dev",
			clientEndpoint: aws.String("https://client-dsql.dev"),
			expectURL:      aws.String("https://client-dsql.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DSQL", c.envService)
			}
