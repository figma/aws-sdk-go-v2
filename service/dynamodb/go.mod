...
require (
	...
	github.com/figma/aws-sdk-go-v2/internal/configsources v1.4.3-figma-multi-test.2
	github.com/figma/aws-sdk-go-v2/internal/endpoints/v2 v2.7.3-figma-multi-test.2
	github.com/figma/aws-sdk-go-v2/service/internal/accept-encoding v1.13.0-figma-multi-test.2
	github.com/figma/aws-sdk-go-v2/service/internal/endpoint-discovery v1.11.3-figma-multi-test.2
