...
require (
	...
	github.com/figma/aws-sdk-go-v2/service/internal/accept-encoding v1.13.0-newtest.1
	github.com/figma/aws-sdk-go-v2/service/internal/endpoint-discovery v1.11.3-newtest.1
