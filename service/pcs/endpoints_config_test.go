...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pcs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pcs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pcs.dev",
			expectURL:     aws.String("https://env-pcs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pcs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pcs.dev",
			expectURL:     aws.String("http://config-pcs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pcs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pcs.dev",
			clientEndpoint: aws.String("https://client-pcs.dev"),
			expectURL:      aws.String("https://client-pcs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PCS", c.envService)
			}
