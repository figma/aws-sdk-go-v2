...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-evs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-evs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-evs.dev",
			expectURL:     aws.String("https://env-evs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-evs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-evs.dev",
			expectURL:     aws.String("http://config-evs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-evs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-evs.dev",
			clientEndpoint: aws.String("https://client-evs.dev"),
			expectURL:      aws.String("https://client-evs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EVS", c.envService)
			}
