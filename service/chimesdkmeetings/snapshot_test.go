...
func TestCheckSnapshot_BatchUpdateAttendeeCapabilitiesExcept(t *testing.T) {
	svc := New(Options{})
	_, err := svc.BatchUpdateAttendeeCapabilitiesExcept(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "BatchUpdateAttendeeCapabilitiesExcept")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestCheckSnapshot_UpdateAttendeeCapabilities(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateAttendeeCapabilities(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "UpdateAttendeeCapabilities")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_BatchUpdateAttendeeCapabilitiesExcept(t *testing.T) {
	svc := New(Options{})
	_, err := svc.BatchUpdateAttendeeCapabilitiesExcept(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "BatchUpdateAttendeeCapabilitiesExcept")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_UpdateAttendeeCapabilities(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateAttendeeCapabilities(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "UpdateAttendeeCapabilities")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
