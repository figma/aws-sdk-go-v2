...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mailmanager.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mailmanager.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mailmanager.dev",
			expectURL:     aws.String("https://env-mailmanager.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mailmanager.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mailmanager.dev",
			expectURL:     aws.String("http://config-mailmanager.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mailmanager.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mailmanager.dev",
			clientEndpoint: aws.String("https://client-mailmanager.dev"),
			expectURL:      aws.String("https://client-mailmanager.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MAILMANAGER", c.envService)
			}
