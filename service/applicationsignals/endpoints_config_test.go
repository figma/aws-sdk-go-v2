...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-application-signals.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-application-signals.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-application-signals.dev",
			expectURL:     aws.String("https://env-application-signals.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-application-signals.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-application-signals.dev",
			expectURL:     aws.String("http://config-application-signals.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-application-signals.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-application-signals.dev",
			clientEndpoint: aws.String("https://client-application-signals.dev"),
			expectURL:      aws.String("https://client-application-signals.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPLICATION_SIGNALS", c.envService)
			}
