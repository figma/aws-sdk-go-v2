...
func TestCheckSnapshot_PutDialRequestBatch(t *testing.T) {
	svc := New(Options{})
	_, err := svc.PutDialRequestBatch(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "PutDialRequestBatch")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestCheckSnapshot_UpdateCampaignDialerConfig(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateCampaignDialerConfig(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "UpdateCampaignDialerConfig")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestCheckSnapshot_UpdateCampaignOutboundCallConfig(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateCampaignOutboundCallConfig(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "UpdateCampaignOutboundCallConfig")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_PutDialRequestBatch(t *testing.T) {
	svc := New(Options{})
	_, err := svc.PutDialRequestBatch(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "PutDialRequestBatch")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_UpdateCampaignDialerConfig(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateCampaignDialerConfig(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "UpdateCampaignDialerConfig")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_UpdateCampaignOutboundCallConfig(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateCampaignOutboundCallConfig(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "UpdateCampaignOutboundCallConfig")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
