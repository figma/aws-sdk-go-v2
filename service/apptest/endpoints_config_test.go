...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-apptest.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apptest.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apptest.dev",
			expectURL:     aws.String("https://env-apptest.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-apptest.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apptest.dev",
			expectURL:     aws.String("http://config-apptest.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-apptest.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-apptest.dev",
			clientEndpoint: aws.String("https://client-apptest.dev"),
			expectURL:      aws.String("https://client-apptest.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPTEST", c.envService)
			}
