...
func (c *Client) addOperationDeleteADAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteADAssessment"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteADAssessment(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteADAssessment(region string) *awsmiddleware.RegisterServiceMetadata {
