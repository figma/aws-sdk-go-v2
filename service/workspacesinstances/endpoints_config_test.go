...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workspaces-instances.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-instances.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-instances.dev",
			expectURL:     aws.String("https://env-workspaces-instances.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workspaces-instances.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-instances.dev",
			expectURL:     aws.String("http://config-workspaces-instances.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workspaces-instances.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workspaces-instances.dev",
			clientEndpoint: aws.String("https://client-workspaces-instances.dev"),
			expectURL:      aws.String("https://client-workspaces-instances.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKSPACES_INSTANCES", c.envService)
			}
