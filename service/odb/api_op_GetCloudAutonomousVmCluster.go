...
import (
	...
	"github.com/figma/aws-sdk-go-v2/service/odb/types"
...
func (c *Client) addOperationGetCloudAutonomousVmClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetCloudAutonomousVmCluster(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetCloudAutonomousVmCluster(region string) *awsmiddleware.RegisterServiceMetadata {
