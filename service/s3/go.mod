...
require (
	...
	github.com/figma/aws-sdk-go-v2/internal/v4a v1.4.3-figma-multi-test.1
	github.com/figma/aws-sdk-go-v2/service/internal/accept-encoding v1.13.0-figma-multi-test.1
	github.com/figma/aws-sdk-go-v2/service/internal/checksum v1.8.3-figma-multi-test.1
	github.com/figma/aws-sdk-go-v2/service/internal/presigned-url v1.13.3-figma-multi-test.1
	github.com/figma/aws-sdk-go-v2/service/internal/s3shared v1.19.3-figma-multi-test.1
