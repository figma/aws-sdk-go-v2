...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pca-connector-scep.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pca-connector-scep.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pca-connector-scep.dev",
			expectURL:     aws.String("https://env-pca-connector-scep.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pca-connector-scep.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pca-connector-scep.dev",
			expectURL:     aws.String("http://config-pca-connector-scep.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pca-connector-scep.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pca-connector-scep.dev",
			clientEndpoint: aws.String("https://client-pca-connector-scep.dev"),
			expectURL:      aws.String("https://client-pca-connector-scep.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PCA_CONNECTOR_SCEP", c.envService)
			}
