...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-gameliftstreams.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gameliftstreams.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gameliftstreams.dev",
			expectURL:     aws.String("https://env-gameliftstreams.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-gameliftstreams.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gameliftstreams.dev",
			expectURL:     aws.String("http://config-gameliftstreams.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-gameliftstreams.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-gameliftstreams.dev",
			clientEndpoint: aws.String("https://client-gameliftstreams.dev"),
			expectURL:      aws.String("https://client-gameliftstreams.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GAMELIFTSTREAMS", c.envService)
			}
