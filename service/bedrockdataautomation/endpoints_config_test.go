...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bedrock-data-automation.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-data-automation.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-data-automation.dev",
			expectURL:     aws.String("https://env-bedrock-data-automation.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bedrock-data-automation.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-data-automation.dev",
			expectURL:     aws.String("http://config-bedrock-data-automation.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bedrock-data-automation.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bedrock-data-automation.dev",
			clientEndpoint: aws.String("https://client-bedrock-data-automation.dev"),
			expectURL:      aws.String("https://client-bedrock-data-automation.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BEDROCK_DATA_AUTOMATION", c.envService)
			}
