...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-security-ir.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-security-ir.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-security-ir.dev",
			expectURL:     aws.String("https://env-security-ir.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-security-ir.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-security-ir.dev",
			expectURL:     aws.String("http://config-security-ir.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-security-ir.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-security-ir.dev",
			clientEndpoint: aws.String("https://client-security-ir.dev"),
			expectURL:      aws.String("https://client-security-ir.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SECURITY_IR", c.envService)
			}
