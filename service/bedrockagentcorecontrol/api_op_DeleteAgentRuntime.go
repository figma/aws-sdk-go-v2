...
func (c *Client) DeleteAgentRuntime(ctx context.Context, params *DeleteAgentRuntimeInput, optFns ...func(*Options)) (*DeleteAgentRuntimeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAgentRuntime", params, optFns, c.addOperationDeleteAgentRuntimeMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*DeleteAgentRuntimeOutput)
