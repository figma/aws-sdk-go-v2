...
func (c *Client) ListMemories(ctx context.Context, params *ListMemoriesInput, optFns ...func(*Options)) (*ListMemoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMemories", params, optFns, c.addOperationListMemoriesMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListMemoriesOutput)
...
func (c *Client) addOperationListMemoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&setOperationInputMiddleware{}, middleware.After); err != nil {
		return err
	}
	err = stack.Serialize.Add(&awsRestjson1_serializeOpListMemories{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsRestjson1_deserializeOpListMemories{}, middleware.After)
	if err != nil {
		return err
	}
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListMemories"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListMemories(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListMemoriesPaginator struct {
	options   ListMemoriesPaginatorOptions
	client    ListMemoriesAPIClient
	params    *ListMemoriesInput
	nextToken *string
	firstPage bool
}
...
func (p *ListMemoriesPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListMemoriesOutput, error) {
	...
	result, err := p.client.ListMemories(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
var _ ListMemoriesAPIClient = (*Client)(nil)

func newServiceMetadataMiddleware_opListMemories(region string) *awsmiddleware.RegisterServiceMetadata {
