...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-notifications.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-notifications.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-notifications.dev",
			expectURL:     aws.String("https://env-notifications.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-notifications.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-notifications.dev",
			expectURL:     aws.String("http://config-notifications.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-notifications.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-notifications.dev",
			clientEndpoint: aws.String("https://client-notifications.dev"),
			expectURL:      aws.String("https://client-notifications.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NOTIFICATIONS", c.envService)
			}
