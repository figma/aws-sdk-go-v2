...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-networkmonitor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkmonitor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkmonitor.dev",
			expectURL:     aws.String("https://env-networkmonitor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-networkmonitor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkmonitor.dev",
			expectURL:     aws.String("http://config-networkmonitor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-networkmonitor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-networkmonitor.dev",
			clientEndpoint: aws.String("https://client-networkmonitor.dev"),
			expectURL:      aws.String("https://client-networkmonitor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NETWORKMONITOR", c.envService)
			}
