...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-taxsettings.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-taxsettings.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-taxsettings.dev",
			expectURL:     aws.String("https://env-taxsettings.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-taxsettings.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-taxsettings.dev",
			expectURL:     aws.String("http://config-taxsettings.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-taxsettings.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-taxsettings.dev",
			clientEndpoint: aws.String("https://client-taxsettings.dev"),
			expectURL:      aws.String("https://client-taxsettings.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TAXSETTINGS", c.envService)
			}
