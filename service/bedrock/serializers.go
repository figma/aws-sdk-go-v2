...
import (
	...
	"context"
	"fmt"
	"github.com/figma/aws-sdk-go-v2/service/bedrock/document"
	internaldocument "github.com/figma/aws-sdk-go-v2/service/bedrock/internal/document"
	"github.com/figma/aws-sdk-go-v2/service/bedrock/types"
...
type awsRestjson1_serializeOpCreateCustomModelDeployment struct {
}

func (*awsRestjson1_serializeOpCreateCustomModelDeployment) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpCreateCustomModelDeployment) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/model-customization/custom-model-deployments")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentCreateCustomModelDeploymentInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsCreateCustomModelDeploymentInput(v *CreateCustomModelDeploymentInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentCreateCustomModelDeploymentInput(v *CreateCustomModelDeploymentInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
	...
	if v.ModelDeploymentName != nil {
		ok := object.Key("modelDeploymentName")
		ok.String(*v.ModelDeploymentName)
	}
...
type awsRestjson1_serializeOpCreateFoundationModelAgreement struct {
}

func (*awsRestjson1_serializeOpCreateFoundationModelAgreement) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpCreateFoundationModelAgreement) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/create-foundation-model-agreement")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentCreateFoundationModelAgreementInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsCreateFoundationModelAgreementInput(v *CreateFoundationModelAgreementInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentCreateFoundationModelAgreementInput(v *CreateFoundationModelAgreementInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
	...
	if v.OfferToken != nil {
		ok := object.Key("offerToken")
		ok.String(*v.OfferToken)
	}
...
type awsRestjson1_serializeOpDeleteCustomModelDeployment struct {
}

func (*awsRestjson1_serializeOpDeleteCustomModelDeployment) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpDeleteCustomModelDeployment) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/model-customization/custom-model-deployments/{customModelDeploymentIdentifier}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "DELETE"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsDeleteCustomModelDeploymentInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsDeleteCustomModelDeploymentInput(v *DeleteCustomModelDeploymentInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}

	if v.CustomModelDeploymentIdentifier == nil || len(*v.CustomModelDeploymentIdentifier) == 0 {
		return &smithy.SerializationError{Err: fmt.Errorf("input member customModelDeploymentIdentifier must not be empty")}
	}
	if v.CustomModelDeploymentIdentifier != nil {
		if err := encoder.SetURI("customModelDeploymentIdentifier").String(*v.CustomModelDeploymentIdentifier); err != nil {
			return err
		}
	}
...
type awsRestjson1_serializeOpDeleteFoundationModelAgreement struct {
}

func (*awsRestjson1_serializeOpDeleteFoundationModelAgreement) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpDeleteFoundationModelAgreement) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/delete-foundation-model-agreement")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentDeleteFoundationModelAgreementInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsDeleteFoundationModelAgreementInput(v *DeleteFoundationModelAgreementInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentDeleteFoundationModelAgreementInput(v *DeleteFoundationModelAgreementInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
type awsRestjson1_serializeOpGetCustomModelDeployment struct {
}

func (*awsRestjson1_serializeOpGetCustomModelDeployment) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpGetCustomModelDeployment) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	if err := awsRestjson1_serializeOpHttpBindingsGetCustomModelDeploymentInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsGetCustomModelDeploymentInput(v *GetCustomModelDeploymentInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpGetUseCaseForModelAccess struct {
}

func (*awsRestjson1_serializeOpGetUseCaseForModelAccess) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpGetUseCaseForModelAccess) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	input, ok := in.Parameters.(*GetUseCaseForModelAccessInput)
	_ = input
	if !ok {
		return out, metadata, &smithy.SerializationError{Err: fmt.Errorf("unknown input parameters type %T", in.Parameters)}
	}

	opPath, opQuery := httpbinding.SplitURI("/use-case-for-model-access")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "GET"
	var restEncoder *httpbinding.Encoder
...
type awsRestjson1_serializeOpListCustomModelDeployments struct {
}

func (*awsRestjson1_serializeOpListCustomModelDeployments) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpListCustomModelDeployments) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	input, ok := in.Parameters.(*ListCustomModelDeploymentsInput)
	_ = input
	if !ok {
		return out, metadata, &smithy.SerializationError{Err: fmt.Errorf("unknown input parameters type %T", in.Parameters)}
	}
	...
	if err := awsRestjson1_serializeOpHttpBindingsListCustomModelDeploymentsInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsListCustomModelDeploymentsInput(v *ListCustomModelDeploymentsInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpListFoundationModelAgreementOffers struct {
}

func (*awsRestjson1_serializeOpListFoundationModelAgreementOffers) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpListFoundationModelAgreementOffers) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/list-foundation-model-agreement-offers/{modelId}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "GET"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsListFoundationModelAgreementOffersInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsListFoundationModelAgreementOffersInput(v *ListFoundationModelAgreementOffersInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
	...
	if len(v.OfferType) > 0 {
		encoder.SetQuery("offerType").String(string(v.OfferType))
	}
...
type awsRestjson1_serializeOpPutUseCaseForModelAccess struct {
}

func (*awsRestjson1_serializeOpPutUseCaseForModelAccess) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpPutUseCaseForModelAccess) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentPutUseCaseForModelAccessInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsPutUseCaseForModelAccessInput(v *PutUseCaseForModelAccessInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentPutUseCaseForModelAccessInput(v *PutUseCaseForModelAccessInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.FormData != nil {
		ok := object.Key("formData")
		ok.Base64EncodeBytes(v.FormData)
	}
