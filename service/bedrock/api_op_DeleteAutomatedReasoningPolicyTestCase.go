...
func (c *Client) addOperationDeleteAutomatedReasoningPolicyTestCaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteAutomatedReasoningPolicyTestCase"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteAutomatedReasoningPolicyTestCase(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteAutomatedReasoningPolicyTestCase(region string) *awsmiddleware.RegisterServiceMetadata {
