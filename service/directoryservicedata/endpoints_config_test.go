...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-directory-service-data.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-directory-service-data.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-directory-service-data.dev",
			expectURL:     aws.String("https://env-directory-service-data.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-directory-service-data.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-directory-service-data.dev",
			expectURL:     aws.String("http://config-directory-service-data.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-directory-service-data.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-directory-service-data.dev",
			clientEndpoint: aws.String("https://client-directory-service-data.dev"),
			expectURL:      aws.String("https://client-directory-service-data.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DIRECTORY_SERVICE_DATA", c.envService)
			}
