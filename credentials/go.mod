...
require (
	...
	github.com/figma/aws-sdk-go-v2/feature/ec2/imds v1.18.3-newtest.1
	github.com/figma/aws-sdk-go-v2/service/sso v1.28.0-newtest.1
	github.com/figma/aws-sdk-go-v2/service/ssooidc v1.33.0-newtest.1
	github.com/figma/aws-sdk-go-v2/service/sts v1.37.0-newtest.1
	github.com/aws/smithy-go v1.22.5
)

require (
	github.com/figma/aws-sdk-go-v2/internal/configsources v1.4.3-newtest.1 // indirect
	github.com/figma/aws-sdk-go-v2/internal/endpoints/v2 v2.7.3-newtest.1 // indirect
	github.com/figma/aws-sdk-go-v2/service/internal/accept-encoding v1.13.0-newtest.1 // indirect
	github.com/figma/aws-sdk-go-v2/service/internal/presigned-url v1.13.3-newtest.1 // indirect
)
