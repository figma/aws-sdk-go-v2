...
require (
	...
	github.com/figma/aws-sdk-go-v2/feature/ec2/imds v1.16.32
	github.com/figma/aws-sdk-go-v2/service/sso v1.25.5
	github.com/figma/aws-sdk-go-v2/service/ssooidc v1.30.3
