...
import (
	...
	internalendpoints "github.com/figma/aws-sdk-go-v2/internal/protocoltest/querycompatiblejsonrpc10/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_QUERY_COMPATIBLE_JSON_RPC_10")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Query Compatible JSON RPC 10", cfg.ConfigSources)
	if found && err == nil {
